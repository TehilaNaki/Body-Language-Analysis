rec = {
    ...
    'calm': 'Relax your body'
            ...
            '\n \n Arms '
            '\n Tense arms are rigid and may be held close to the body.'
            '\n They may move in suddenly, a staccato manner. Relaxed arms either hang loosely or move smoothly.'
            ...
            '\n \n Hands '
            '\n When we are anxious, we often use our hands to touch ourselves,'
            '\n hold ourselves/otherwise show tension. may shape ideas in the air.'
            '\n Gestures are open and gentle, not sudden nor tense. '
            '\n \n Legs'
            '\n Legs when sitting may sit gently on the floor or may be casually flung out.'
            '\n They may move in time to music, with tapping toes.'
            '\n They may be crossed, but are not wound around one another. '
            '\n Note that legs can be a particular sign of hidden tension when the person is controlling the upper '
            '\n body and arms. When they are sitting at a table, what you see may be relaxed,'
    ...
    'reliability': 'Tilt your head'
                   ...
                   '\n to display trust, commitment, approval or interest, we bare our neck to others,'
                   '\n We show that we are ready to listen, without contradiction. '
